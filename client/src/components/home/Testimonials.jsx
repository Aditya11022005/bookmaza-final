...
const Testimonials = () => {
  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 relative">
      ...
      <div className="w-full flex md:grid overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-4 md:pb-0 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 [ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        {tests.map((t, i) => (
          <div key={i} className="bg-white p-6 sm:p-7 md:p-10 rounded-2xl border border-[#e2e8f0] shadow-sm relative hover:shadow-[0_15px_35px_-10px_rgba(106,13,173,0.15)] hover:border-primary-200 transition-all duration-300 transform hover:-translate-y-1 group w-[290px] md:w-auto snap-center shrink-0">
