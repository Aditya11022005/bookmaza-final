...
const VerifyResetOTP = () => {
  ...
  const userEmail = localStorage.getItem('resetEmail') || "your email";
  ...
  const submitHandler = async (e) => {
    ...
    try {
      await axios.post('/users/verifyotp', { email: userEmail, otp: otpValue });
  ...
  const handleResend = async () => {
    try {
      await axios.post('/users/forgotpassword', { email: userEmail });
      setTimer(60);
      setOtp(['', '', '', '', '', '']);
    ...
    <div className="min-h-[85vh] flex items-center justify-center bg-[#f8fafc] p-4 sm:p-8 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-poppins font-black text-[#1e293b] mb-3">Verify Identity</h2>
